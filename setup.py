...
packages = ["tag_youre_it", "tag_youre_it.core", "tag_youre_it.domain", "tag_youre_it.services"]

package_data = {"": ["*"]}

install_requires = ["asyncpraw>=7.5.0,<8.0.0", "emoji>=2.1.0,<3.0.0", "pydantic>=1.10.2,<2.0.0"]
